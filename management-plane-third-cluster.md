...
helm upgrade --kube-context ${MGMT} -i gloo-platform-crds gloo-platform/gloo-platform-crds -n gloo-mesh --create-namespace --version=2.10.1
helm upgrade --kube-context ${MGMT} -i gloo-platform gloo-platform/gloo-platform -n gloo-mesh --version 2.10.1 --values mgmt-values-dedicated.yaml \
